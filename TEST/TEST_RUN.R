...
t1 <- Sys.time()
salaries <- import_salaries("C:/Users/Jim/Documents/dfs/dk/nba/inputs/DKSalaries_20180210_night.csv", 
                            from_entry = TRUE)
...
entry_list <- import_entries("C:/Users/Jim/Documents/dfs/dk/nba/inputs/DKEntries_20180210_night.csv")
