...
t1 <- Sys.time()
salaries <- import_salaries("C:/Users/Jim/Documents/dfs/dk/nba/DKSalaries_20180205_turbo.csv", 
                            from_entry = TRUE)
...
entry_list <- import_entries("C:/Users/Jim/Documents/dfs/dk/nba/DKEntries_20180205_turbo.csv")
